...
$count = 1;
$w = ($tw_thumb_width > 0 ? $tw_thumb_width : 295);
$h = ($tw_thumb_height > 0 ? $tw_thumb_height : 261);
...
if ($tw_post->have_posts()):
    ...
    >
        <div class="org_product_carousel productSlider03 owl-carousel">
            <?php
