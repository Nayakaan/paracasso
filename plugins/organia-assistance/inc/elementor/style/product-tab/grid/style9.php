    ...
    <div class="org_prodocut_tab woocommerce">
        ...
        <div class="tab-content">
            ...
            foreach ($pr_tab_list as $key => $pr_tab):
                ...
                $count = 1;
                $w = ($tw_thumb_width > 0 ? $tw_thumb_width : 290);
                $h = ($tw_thumb_height > 0 ? $tw_thumb_height : 237);
                ?>
                    ...
                    <div class="row woocommerce <?php echo($enable_round_corner == 'yes' ? 'hasRoundedCorner' : ''); ?>">
                        <?php if ($tw_post->have_posts()): ?>
                            <?php while ($tw_post->have_posts()): ?>
                                ...
                                ?>
                                <div class="col-xl-<?php echo round(12 / $tw_col_per_row); ?> col-md-6 <?php echo(function_exists('organia_check') && $enable_round_corner == 'yes' ? organia_check($count) : 'odd'); ?>">
                                    <div <?php wc_product_class('organia_product_wrapper', $product); ?>>
                                        <div class="productItem06 proItem08">
