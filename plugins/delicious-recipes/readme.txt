...
* Fixes - Time calculation in Dynamic Recipe card and Recipe Details b fixed.
* Fixes - Minor bug fixes.
...
* New Feature - What's New page added with helpful information and support links.
* Enhancement - WordPress 5.7 compatibility testing.
* Fixes - Minor bug fixes.

= 1.1.3 - 25th February 2021 =
* Fixes - WPML config file added.
* Fixes - Recipes by Taxonomy b issue fixes.
...
New Features
* Custom Icons - A feature to upload custom icons for Taxonomies.
* Custom Units - A feature to add custom quantity units for ingredients.
* Mark as complete - A feature to mark your instruction steps as complete.
